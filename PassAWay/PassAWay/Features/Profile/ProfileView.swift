        ...
        ZStack {
            ...
            if viewModel.isLoading {
                    ...
                    ScrollView {
                        VStack(spacing: 20) {
                            ...
                            HStack(alignment: .top) {
                                HStack(spacing: 15) {
                                    ZStack {
                                        ...
                                        // TODO: Later, replace this with AsyncImage using user.profileImageUrl
                            ...
                            VStack(alignment: .center, spacing: 15) {
                                ...
                                // DYNAMIC EMPTY STATE VS CAROUSEL
                                if user.itemsListed == 0 {
                                    // Empty State
                                    VStack(spacing: 12) {
                                    ...
                                    // Carousel (Will map actual items eventually)
                                    ScrollView(.horizontal, showsIndicators: false) {
                                        HStack(spacing: 15) {
                                            ForEach(0..<user.itemsListed, id: \.self) { index in
                            ...
                            VStack(spacing: 15) {
                                ...
                                Button(action: {
                                    viewModel.logOut() // Hooked up to ViewModel logout
                                }) {
                                    HStack {
                ...
                VStack(spacing: 20) {
                    ...
                    // ESCAPE HATCH BUTTON
                    Button(action: {
                        viewModel.logOut() // Clears the broken cache and routes to BootUpView
                    }) {
                        Text("Force Log Out")
                            .fontWeight(.bold)
